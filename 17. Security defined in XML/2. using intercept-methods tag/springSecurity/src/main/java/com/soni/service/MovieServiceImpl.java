...
// We have to define <security:intercept-methods> tag as a child of MovieServiceImpl bean so we have to define this
// bean in xml using <bean> tag. So there is no point of uisng @Service to register MovieServiceImpl as bean.
//@Service
public class MovieServiceImpl implements MovieService {
	...
	// This method is secured using <security:intercept-methods> tag in spring-security.xml file.
